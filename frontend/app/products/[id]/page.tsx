...
//             <div className="p-6 bg-white border border-gray-100 shadow-xl rounded-3xl">
//               <div className="relative overflow-hidden aspect-square rounded-2xl bg-gradient-to-br from-gray-50 to-gray-100">
//                 {imageLoading && (
...
//                   <button className="p-3 transition-colors duration-200 rounded-full shadow-lg bg-white/90 backdrop-blur-sm hover:bg-white">
//                     <FaHeart className="w-5 h-5 text-gray-600 hover:text-red-500" />
//                   </button>
//                   <button className="p-3 transition-colors duration-200 rounded-full shadow-lg bg-white/90 backdrop-blur-sm hover:bg-white">
//                     <FaShare className="w-5 h-5 text-gray-600 hover:text-blue-500" />
//                   </button>
//                   <button className="p-3 transition-colors duration-200 rounded-full shadow-lg bg-white/90 backdrop-blur-sm hover:bg-white">
...
//                     <div className="flex items-center px-4 py-2 space-x-2 text-sm font-semibold text-white bg-green-500 rounded-full shadow-lg">
//                       <Check className="w-4 h-4" />
//                       <span>In Stock ({product.stock})</span>
//                     </div>
//                   ) : (
//                     <div className="px-4 py-2 text-sm font-semibold text-white bg-red-500 rounded-full shadow-lg">
//                       Out of Stock
//                     </div>
//                   )}
//                 </div>
...
//                     </span>
//                     <span className="flex items-center px-3 py-1 space-x-1 text-sm font-medium text-green-700 bg-green-100 rounded-full">
...
//                       {product && (parseFloat(product.price) * 1.2).toFixed(0)}{" "}
//                       RUB
//                     </span>
//                     <span className="px-2 py-1 text-sm font-semibold text-red-700 bg-red-100 rounded-lg">
//                       20% OFF
//                     </span>
//                   </div>
//                 </div>
...
//                   <div className="flex items-center p-3 space-x-2 bg-green-50 rounded-xl">
//                     <FaShippingFast className="w-5 h-5 text-green-600" />
//                     <span className="text-sm font-medium text-green-800">
//                       FREE SHIPPING
//                     </span>
//                   </div>
//                   <div className="flex items-center p-3 space-x-2 bg-purple-50 rounded-xl">
...
//                     </span>
//                   </div>
//                   <div className="flex items-center p-3 space-x-2 bg-orange-50 rounded-xl">
...
//                 {/* Promotion Banner */}
//                 <div className="p-4 text-center bg-gradient-to-r from-yellow-400 to-orange-500 rounded-2xl">
//                   <div className="flex items-center justify-center space-x-2 text-white">
//                     <Sparkles className="w-5 h-5" />
//                     <span className="font-bold">Limited Time Offer!</span>
//                   </div>
//                   <p className="mt-1 text-sm text-white/90">
//                     Promotion expires: 9h00pm, 25/5/2024
//                   </p>
//                 </div>
//               </div>
//             </div>
...
//               <div className="space-y-6">
//                 {/* Total Price */}
//                 <div className="p-6 text-center border border-green-200 bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl">
...
//                     <span className="font-semibold">$49/m</span>
...
//                     Quantity
//                   </label>
//                   <div className="flex items-center justify-center p-4 space-x-4 bg-gray-50 rounded-2xl">
//                     <Button
//                       onClick={handleDecrease}
//                       disabled={count <= 1}
//                       className="w-12 h-12 transition-shadow duration-200 bg-white rounded-full shadow-md hover:shadow-lg disabled:opacity-50"
//                       variant="outline"
//                     >
//                       <FcMinus className="w-5 h-5" />
//                     </Button>
...
//                       className="w-12 h-12 transition-shadow duration-200 bg-white rounded-full shadow-md hover:shadow-lg"
//                       variant="outline"
//                     >
...
//                 {/* Action Buttons */}
//                 <div className="space-y-3">
//                   <Button className="w-full py-4 font-semibold text-white transition-all duration-300 transform shadow-lg bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 rounded-2xl hover:shadow-xl hover:scale-105">
//                     <ShoppingCart className="w-5 h-5 mr-2" />
//                     ADD TO CART
//                   </Button>

//                   <Button className="w-full py-4 font-semibold text-white transition-all duration-300 transform shadow-lg bg-gradient-to-r from-yellow-500 to-orange-500 hover:from-yellow-600 hover:to-orange-600 rounded-2xl hover:shadow-xl hover:scale-105">
//                     <FaCcPaypal className="w-5 h-5 mr-2" />
//                     BUY WITH PAYPAL
//                   </Button>
//                 </div>
...
//                   <button className="flex items-center space-x-2 text-sm text-gray-600 transition-colors hover:text-gray-900">
...
//             {/* Quick Order Card */}
//             <div className="p-8 text-white shadow-xl bg-gradient-to-r from-gray-900 to-gray-800 rounded-3xl">
//               <div className="space-y-4 text-center">
//                 <div className="inline-flex items-center px-4 py-2 space-x-2 rounded-full bg-white/20 backdrop-blur-sm">
//                   <Phone className="w-4 h-4" />
//                   <span className="text-sm font-medium">QUICK ORDER 24/7</span>
//                 </div>

//                 <div className="text-3xl font-bold">(025) 3886 25 16</div>
...
//               <button
//                 key={index}
//                 className={`w-12 h-12 ${social.color} text-white rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110`}
