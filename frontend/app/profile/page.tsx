...
//     {
//       id: "devices",
//       text: "Recently logged in devices",
...
//         >
//           <div className="flex flex-col w-full px-5 py-6 mx-auto text-sm text-black rounded-xl bg-neutral-50 max-md:mt-10">
//             <ProfileImage
...
//               <button
//                 type="submit"
//                 className="px-12 py-5 text-xs font-medium text-center text-white uppercase transition-colors bg-green-600 mt-11 whitespace-nowrap rounded-xl hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 max-md:px-5 max-md:mt-10"
