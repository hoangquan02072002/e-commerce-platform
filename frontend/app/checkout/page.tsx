...
//         <div className="p-6 border rounded-xl bg-stone-100 border-stone-200">
...
//               <button
//                 type="submit"
//                 className="w-full px-6 py-4 text-sm font-medium text-white uppercase transition-colors bg-green-600 rounded-xl hover:bg-green-700"
//               >
//                 Place order
//               </button>
//             </div>
